    ...
    public class Dust : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            }))
            {
                ...
                var dis = Random(0.05,0.5);
                for (var startTime = (double)StartTime; startTime <= EndTime - (particleDuration/dis) ; startTime += timeStep)
                {
                    ...
                    sprite.Move(easing, startTime, endTime, startX, startY, endX + Random(-100,100), endY - 200 );
                    sprite.ColorHsb(startTime,endTime,0,0,1,0,1,1);
                    ...
                    if (StartScale != EndScale)
                        ...
                        else sprite.Scale(easing, startTime, endTime, dis, 0);
